...
RSpec.describe Bemer::ModifierList do
  ...
  context 'when transform_string_values is set to false' do
    let(:modifiers_as_array) { %w[block__elem_hidden block__elem_theme_green-islands block__elem_disabled block__elem_has_tail] }
  ...
  context 'when transform_string_values is set to true' do
    let(:modifiers_as_array) { %w[block__elem_hidden block__elem_theme_green-islands block__elem_disabled block__elem_has-tail] }
